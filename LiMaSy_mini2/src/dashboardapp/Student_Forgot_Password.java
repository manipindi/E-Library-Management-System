...
public class Student_Forgot_Password extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Student_Forgot_Password
     */
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        else if(jTextField2.getText().isEmpty()){JOptionPane.showMessageDialog(null, "search username");}
        else if(jTextField3.getText().isEmpty()){JOptionPane.showMessageDialog(null, "search username");}
        ...
        try{
            Conn con=new Conn();
        String sql = "update account set password=? where (username=? and sec_ans=?)";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Student_Forgot_Password.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
